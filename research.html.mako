...
<ul>
<li><a href="#sec-1">1. Data sharing and functional scientific documents</a></li>
<li><a href="#sec-2">2. Alloy catalysis</a></li>
<li><a href="#sec-3">3. CO<sub>2</sub> Capture</a></li>
<li><a href="#sec-4">4. Metal oxide reactivity</a></li>
<li><a href="#sec-5">5. Oxygen evolution electrocatalysis</a></li>
<li><a href="#sec-6">6. Coverage dependent adsorption</a></li>
</ul>
</div>
</div>
...
<h2 id="sec-1"><span class="section-number-2">1</span> Data sharing and functional scientific documents</h2>
<div class="outline-text-2" id="text-1">
<p>
We are huge proponents of using org-mode to write scientific documents. This has enabled our group to develop novel data sharing strategies <a href="#kitchin-2015-examp">kitchin-2015-examp</a>,<a href="#kitchin-2015-data-surfac-scien">kitchin-2015-data-surfac-scien</a> and increase our productivity significantly.
</p>
</div>
</div>

<div id="outline-container-sec-2" class="outline-2">
<h2 id="sec-2"><span class="section-number-2">2</span> Alloy catalysis</h2>
<div class="outline-text-2" id="text-2">
<p>
Alloy catalysts frequently do not have the same reactivity as the parent metals. We use density functional theory calculations to understand how the electronic structure of the alloy differs from the parent metals, and how those differences lead to different reactivities. We are especially interested in modeling heterogeneous site distributions <a href="#boes-2015-estim-bulk">boes-2015-estim-bulk</a>, modeling XPS spectra of alloys <a href="#boes-2015-core-cu">boes-2015-core-cu</a>, and the limit of single atom alloys <a href="#tierney-2009-hydrog-dissoc">tierney-2009-hydrog-dissoc</a>.
</p>

<p>
We have used density functional theory to identify S-tolerant alloys <a href="#inoglu-2011-ident-sulfur">inoglu-2011-ident-sulfur</a>. Our current work will develop a new understanding of selectivity in acetylene hydrogenation.
</p>
</div>
</div>
...
<h2 id="sec-3"><span class="section-number-2">3</span> CO<sub>2</sub> Capture</h2>
<div class="outline-text-2" id="text-3">
<p>
CO<sub>2</sub> capture remains an important tool in considering how to mitigate the role of fossil energy on climate change <a href="#rubin-2012">rubin-2012</a>. We have investigated the use of supported amines <a href="#alesi-2010-co2-adsor">alesi-2010-co2-adsor</a>, and a commercially available ion exchange resin as a CO<sub>2</sub> capture sorbent <a href="#alesi-2012-evaluat-primar">alesi-2012-evaluat-primar</a>. We have shown that supported amines are poisoned by SO<sub>2</sub>, but may they may be partially regenerated in some cases <a href="#hallenbeck-2013-effec-o2">hallenbeck-2013-effec-o2</a>.
</p>


<p>
We have used density functional theory calculations to model amine-CO<sub>2</sub> reactions <a href="#lee-2012-chemic-molec">lee-2012-chemic-molec</a>,<a href="#mao-2013-inter">mao-2013-inter</a>, as well as process modeling to show that different process conditions are required to optimize a capture process for different solvents <a href="#lee-2013-compar-co2">lee-2013-compar-co2</a>. We have considered ionic liquids as potential CO<sub>2</sub> capture solvents <a href="#thompson-2014-co2-react">thompson-2014-co2-react</a>.
</p>
...
<p>
We previously explored the electrochemical separation of CO<sub>2</sub> from flue gas <a href="#landon-2010-elect-concen">landon-2010-elect-concen</a>,<a href="#pennline-2010-separ-co2">pennline-2010-separ-co2</a>.
</p>


<p>
PhD Anita Lee: <a href="#lee-2013-multi-scale">lee-2013-multi-scale</a>
</p>

<p>
PhD Rich Alesi: <a href="#walesi-2012-amine-based-sorben">walesi-2012-amine-based-sorben</a>
</p>
</div>
</div>

<div id="outline-container-sec-4" class="outline-2">
<h2 id="sec-4"><span class="section-number-2">4</span> Metal oxide reactivity</h2>
...
<p>
We derived a number of heuristic rules that describe the reactivity of perovskites <a href="#akhade-2011-effec">akhade-2011-effec</a>,<a href="#akhade-2012-effec">akhade-2012-effec</a>. These principles were expanded into a concept of outer electrons that was used to describe the reactivity of a broad range of oxides <a href="#calle-vallejo-2013-number">calle-vallejo-2013-number</a>. These observations have been found to be robust across a broad range of assumptions in the models used, although some care must be taken in a few cases <a href="#curnan-2014-effec-concen">curnan-2014-effec-concen</a>. We have found novel relationships between oxide electronic structure and reactivity for oxides with rocksalt structures <a href="#xu-2014-relat">xu-2014-relat</a>.
</p>

<p>
We did some work in infiltrating solid oxide fuel cell electrodes with
electrocatalysts to improve their activity
<a href="#chao-2011-prepar-mesop">chao-2011-prepar-mesop</a>,<a href="#chao-2012-struc-relat">chao-2012-struc-relat</a>.
</p>

<p>
An outstanding challenge in modeling oxides is the highly correlated electrons especially in the 3d orbitals of transition metals. We have expanded an approach to use a linear response method to compute U, making a nearly predictive, first-principles method for computing oxide formation energies with pretty good accuracy <a href="#xu-2015-accur-u">xu-2015-accur-u</a>.
</p>

<p>
One new direction we have taken is to identify oxide polymorphs that may be grown as epitaxial thin films <a href="#mehta-2014-ident-poten">mehta-2014-ident-poten</a>.
</p>

<p>
PhD Robin Chao: <a href="#chao-2012-improv-solid">chao-2012-improv-solid</a>
</p>
</div>
</div>

<div id="outline-container-sec-5" class="outline-2">
<h2 id="sec-5"><span class="section-number-2">5</span> Oxygen evolution electrocatalysis</h2>
<div class="outline-text-2" id="text-5">
<p>
We are using Raman spectroscopy to probe the oxide/electrolyte interface under oxygen evolution conditions. We have focused most of our work on Ni-oxide containing materials, which are highly active when promoted by Fe impurities <a href="#landon-2012-spect-charac">landon-2012-spect-charac</a>,<a href="#michael-2015-alkal-elect">michael-2015-alkal-elect</a>. We have also examined Fe-containing molecular electrocatalysts
<a href="#demeter-2014-elect-oxygen">demeter-2014-elect-oxygen</a>.
</p>

<p>
We have used density functional theory to show that there are correlations in the reactions of the oxygen evolution reaction that likely limit the activity of oxide-based electrocatalysts <a href="#man-2011-univer-oxygen">man-2011-univer-oxygen</a>. These observations are robust, even with advanced computational methods such as the linear response DFT+U methods <a href="#xu-2015-linear-respon">xu-2015-linear-respon</a>.
</p>

<p>
PhD James Landon: <a href="#landon-2011-elect-oxygen-produc">landon-2011-elect-oxygen-produc</a>
</p>

<p>
PhD Ethan Demeter: <a href="#demeter-2013-promot-base">demeter-2013-promot-base</a>
</p>
</div>
</div>

<div id="outline-container-sec-6" class="outline-2">
<h2 id="sec-6"><span class="section-number-2">6</span> Coverage dependent adsorption</h2>
<div class="outline-text-2" id="text-6">
<p>
Our earliest work was in modeling the coverage dependent adsorption energies of atomic adsorbates on late transition metal surfaces. We showed that there exist strong configurational correlations for many adsorbates on Pd(111) <a href="#kitchin-2009-correl-pd">kitchin-2009-correl-pd</a>, and for oxygen on late transition metal surfaces <a href="#miller-2009-relat-au">miller-2009-relat-au</a>,<a href="#miller-2011-config">miller-2011-config</a>. These principles were generalized in a simple physical model <a href="#inoglu-2010-simpl">inoglu-2010-simpl</a> that showed the origin of the coverage dependence was an adsorbate-induced modification of the surface electronic structure. We wrote a review book chapter on this topic <a href="#miller-2012-cover">miller-2012-cover</a>. We demonstrated that DFT can be used to interpret the coverage dependent desorption behavior of oxygen on Pt(111) <a href="#miller-2014-simul-temper">miller-2014-simul-temper</a>.  Finally, we showed the generality of configurational correlations across many surfaces and for many adsorbates, demonstrating that geometric similarity is a requirement for correlation <a href="#xu-2014-probin-cover">xu-2014-probin-cover</a>.
</p>

<p>
PhD Spencer Miller: <a href="#miller-2011-towar-under">miller-2011-towar-under</a>
</p>

<p>
PhD Nilay Inoglu: <a href="#inoglu-2012-desig-sulfur">inoglu-2012-desig-sulfur</a>
</p>

<p>
<h1>Bibliography</h1>
<ul><li><a id="akhade-2011-effec">[akhade-2011-effec] Akhade & Kitchin, Effects of Strain, D-Band Filling, and Oxidation State on the  Bulk Electronic Structure of Cubic 3d Perovskites, <i>The Journal of Chemical Physics</i>, <b>135(10)</b>, 104702-6 (2011). <a href="http://dx.doi.org/10.1063/1.3631948">link</a>.</a></li>
...
<li><a id="kitchin-2015-data-surfac-scien">[kitchin-2015-data-surfac-scien] "John Kitchin", Data Sharing in Surface Science, <i>"Surface Science "</i>, <b>(0)</b>,  -  (2015). <a href="http://www.sciencedirect.com/science/article/pii/S0039602815001326">link</a>. <a href="http://dx.doi.org/10.1016/j.susc.2015.05.007">doi</a>.</a></li>
...
<li><a id="miller-2011-towar-under">[miller-2011-towar-under] @phdthesismiller-2011-towar-under,
  ...
  Title =	 Towards an Understanding of Coverage Dependent
Atomic Adsorption on Late Transition Metals,
  School =	 Carnegie Mellon University,
  Year =	 2011</a></li>
<li><a id="miller-2012-cover">[miller-2012-cover] @inbookmiller-2012-cover,
  ...
  Title = Coverage dependent adsorption properties of atomic adsorbates on late transition metal surfaces,
...
<li><a id="walesi-2012-amine-based-sorben">[walesi-2012-amine-based-sorben] @phdthesiswalesi-2012-amine-based-sorben,
  ...
  Title =	 Amine Based Sorbents :
Developing a Quantitative Framework for
