...
cite:kitchin-2008-chemic-model,han-2009-step
#+BEGIN_SRC emacs-lisp
(require 'helm-bibtex)
...
I want to find all my org-files that cite this paper cite:kitchin-2004-role.
...
#+BEGIN_SRC emacs-lisp
(find-lisp-find-dired "~/Dropbox/CMU/manuscripts" ".*.org")
#+END_SRC
#+RESULTS:
