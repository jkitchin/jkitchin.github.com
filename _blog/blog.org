* DONE Pycse is now using Python3
  ...
  :END:
I spent the last couple of days going through the notes for [[http://kitchingroup.cheme.cmu.edu/pycse][pycse]] and updating it for Python 3! It is mostly done, and mostly was pretty easy. The Python module for pycse (http://github.com/jkitchin/pycse) should also be Python 3 compliant. Yep, on my Mac I have switched over to the Anaconda Python 3 from Continuum IO (thanks for that!).
...
#+END_SRC
#+RESULTS:
: Mon Feb 22 10:29:46 EST 2016
: Mon Feb 22 10:29:46 EST 2016

#+BEGIN_SRC emacs-lisp
(setq org-export-babel-evaluate t org-export-async-debug t)
#+END_SRC
#+RESULTS:
: t


* Uncoupling org-ref from helm
...
* Using ivy-mode to insert citations in org-ref
  :PROPERTIES:
...
(setq org-ref-cite-onclick-function 'ivy-cite)
#+END_SRC
...
* generating figures and tables with captions and properties
...
* Python 3.5 has arrived on my laptop
