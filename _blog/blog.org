...
* Scopus Chemical engineering departments publication analysis
...
http://www.university-list.net/us/rank/univ-20121038.htm



#+BEGIN_SRC python :var cmu=cmu-cheme stanford=stanford-cheme princeton=princeton-cheme delaware=delaware-cheme gatech=gatech-cheme mit=MIT-cheme minnesota=minnesota-cheme bk=berkeley-cheme uw=uw-cheme ucsb=ucsb-cheme caltech=caltech-cheme austin=ut-austin-cheme
import matplotlib.pyplot as plt

plt.plot([year for (year, N) in mit], [N for (year, N) in mit], label='MIT (1)')
plt.plot([year for (year, N) in caltech], [N for (year, N) in caltech], label='CalTech (2)')
plt.plot([year for (year, N) in bk], [N for (year, N) in bk], label='Berkeley (3)')
plt.plot([year for (year, N) in gatech], [N for (year, N) in gatech], label='Ga Tech (10)')
plt.plot([year for (year, N) in minnesota], [N for (year, N) in minnesota], label='Minnesota (4)')
plt.plot([year for (year, N) in stanford], [N for (year, N) in stanford], label='Stanford (4)')
plt.plot([year for (year, N) in princeton], [N for (year, N) in princeton], label='Princeton (6)')
plt.plot([year for (year, N) in delaware], [N for (year, N) in delaware], label='Delaware (11)')
plt.plot([year for (year, N) in uw], [N for (year, N) in uw], label='UW-Madison (6)')
plt.plot([year for (year, N) in austin], [N for (year, N) in austin], label='UT Austin (6)')
plt.plot([year for (year, N) in ucsb], [N for (year, N) in ucsb], label='UCSB (9)')
plt.plot([year for (year, N) in cmu], [N for (year, N) in cmu], 'k-', linewidth=2, label='CMU (13)')
...
#+BEGIN_SRC python :var cmu=cmu-cheme purdue=purdue-cheme umich=umich-cheme illinois=illinois-cheme nw=nw-cheme ucb=ucb-cheme upenn=upenn-cheme cornell=cornell-cheme ncsu=ncsu-cheme
import matplotlib.pyplot as plt

plt.plot([year for (year, N) in upenn], [N for (year, N) in upenn], label='U Penn (18)')
plt.plot([year for (year, N) in purdue], [N for (year, N) in purdue], label='Purdue (13)')
plt.plot([year for (year, N) in nw], [N for (year, N) in nw], label='Northwestern (17)')
plt.plot([year for (year, N) in umich], [N for (year, N) in umich], label='U. Michigan (12)')
plt.plot([year for (year, N) in illinois], [N for (year, N) in illinois], label='Illinois UC (13)')

plt.plot([year for (year, N) in ucb], [N for (year, N) in ucb], label='UC-Boulder (18)')
plt.plot([year for (year, N) in cornell], [N for (year, N) in cornell], label='Cornell (16)')
plt.plot([year for (year, N) in ncsu], [N for (year, N) in ncsu], label='NCSU (20)')
plt.plot([year for (year, N) in cmu], [N for (year, N) in cmu], 'k-', linewidth=2, label='CMU (13)')
...
| 1938 |   4 |
*** CMU
http://www.scopus.com/term/analyzer.url?sid=33542DD72D5801B7D6B8B5D2D4B7218C.CnvicAmOODVwpVrjSeqQ%3a30&origin=resultslist&src=s&s=%28AFFIL%28carnegie+mellon+university%29+AND+AFFIL%28chemical+engineering%29%29&sort=plf-f&sdt=b&sot=b&sl=67&count=3184&analyzeResults=Analyze+results&txGid=33542DD72D5801B7D6B8B5D2D4B7218C.CnvicAmOODVwpVrjSeqQ%3a11#spreadsheet
[[http://www.scopus.com/term/analyzer.url?sid%3D33542DD72D5801B7D6B8B5D2D4B7218C.CnvicAmOODVwpVrjSeqQ%253a720&origin%3Dresultslist&src%3Ds&s%3D%2528AFFIL%2528University%2Bof%2BMinnesota%2529%2BAND%2BAFFIL%2528chemical%2Bengineering%2529%2529&sort%3Dplf-f&sdt%3Db&sot%3Db&sl%3D64&count%3D5799&analyzeResults%3DAnalyze%2Bresults&txGid%3D33542DD72D5801B7D6B8B5D2D4B7218C.CnvicAmOODVwpVrjSeqQ%253a78#spreadsheet][Scopus - Analyze search results]]
#+tblname: minnesota-cheme
| 2015 |  66 |
| 2014 | 279 |
| 2013 | 246 |
| 2012 | 281 |
...
| 1932 |   1 |
*** U Michigan
[[http://www.scopus.com/term/analyzer.url?sid%3D33542DD72D5801B7D6B8B5D2D4B7218C.CnvicAmOODVwpVrjSeqQ%253a1040&origin%3Dresultslist&src%3Ds&s%3D%2528AFFIL%2528University%2Bof%2BMichigan%2529%2BAND%2BAFFIL%2528chemical%2Bengineering%2529%2BAND%2BAFFILCITY%2528ann%2Barbor%2529%2529&sort%3Dplf-f&sdt%3Db&sot%3Db&sl%3D88&count%3D3621&analyzeResults%3DAnalyze%2Bresults&txGid%3D33542DD72D5801B7D6B8B5D2D4B7218C.CnvicAmOODVwpVrjSeqQ%253a110#spreadsheet][Scopus - Analyze search results]]
#+tblname: umich-cheme
| 2015 |  53 |
| 2014 | 234 |
| 2013 | 210 |
...
According to http://api.elsevier.com/documentation/AbstractRetrievalAPI.wadl, the native form of the Scopus abstract document is xml, and the full abstract cannot always be represented  as json. So... I am going to just bite the bullet and learn to deal with the xml.
...
Here is the main code to get what we want out.
...
#+BEGIN_SRC python :results html :var data=my-eids
from scopus_xml import *
...
requests.el [[http://tkf.github.io/emacs-request/][Request.el â€“ Easy HTTP request for Emacs Lisp â€” Request.el 0.2.0 documentation]]
...
This paper came out shortly after I spent three months at DTU with Jens NÃ¸rskov when I was a PhD student. I still remember talking to him about the work that led to this paper one day at their regular afternoon department tea time. He suggested some DFT calculations that I knew how to do, and I went back to the office and worked on them the rest of the night. He wrote this amazing paper afterwards that has been cited over and over. Congratulations Jens! I am proud to have had a part in it.
...
WNS.keysZNS.objectsV$class¢€€¢€€€\relativePathYaliasData_.../../../../../Documents/Papers/Albin/2006.pdfÒWNS.dataOŠ    Š   Macintosh HD               Ì’KPH+  	ôjË2006.pdf                                                       	ôk€Ðó4—            	                Albin     Ì’­À      Ðó¥    	ôjË ×Ü Ê" Ê! J  ?Macintosh HD:Users: stanton: Documents: Papers: Albin: 2006.pdf     2 0 0 6 . p d f    M a c i n t o s h   H D  -Users/stanton/Documents/Papers/Albin/2006.pdf   /    ÿÿ  €ÒZ$classnameX$classes]NSMutableData£ VNSDataXNSObjectÒ"#\NSDictionary¢" _NSKeyedArchiverÑ&'Troot€    # - 2 7 @ F M U ` g j l n q s u w „ Ž ¿ Ä ÌZ\aluƒ‡Ž—œ©¬¾ÁÆ             (              È
