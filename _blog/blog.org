...
(defvar gravy-d 'backward-char
  "Function for d
The previous item in a backward sense.")

(defvar gravy-f 'previous-line
  "Function for f.
The previous item in an up sense.")

(defvar gravy-j 'next-line
  "Function for l.
The next item in a down sense.")

(defvar gravy-k 'forward-char
  "Function for k.
...
_d_: ← _f_: ↑ _j_: ↓ _k_: →"
  ...
  ("a" (call-interactively gravy-beginning))
  ...
  ("c" (lambda ()
	 (interactive)
	 (setq gravy-d 'backward-char
	       gravy-f 'previous-line
	       gravy-k 'forward-char 
	       gravy-j 'next-line
  ...
  ("w" (lambda ()
	 (interactive)
	 (setq gravy-d 'backward-word
	       gravy-f 'previous-line
	       gravy-k 'forward-word 
	       gravy-j 'next-line
  ...
  ("s" (lambda ()
	 (interactive)
	 (setq gravy-d 'backward-sentence
	       gravy-k 'previous-line
	       gravy-j 'next-line
	       gravy-k 'forward-sentence 
	       gravy-avy-2 avy-goto-char-2
  ...
  ("p" (lambda ()
	 (interactive)
	 (setq gravy-d 'backward-paragraph
	       gravy-k 'forward-paragraph
	       gravy-f 'previous-line
	       gravy-j 'next-line
	       gravy-avy-2 avy-goto-char-2
	       gravy-avy-3 avy-goto-line))
  ...
  ("x" (lambda ()
	 (interactive)
	 (setq gravy-d 'backward-sexp
	       gravy-k 'forward-sexp
	       gravy-f 'previous-line
	       gravy-j 'next-line
