...
John Kitchin @johnkitchin

this worked at home, and now does not work.
...
(let ((most-recent (car
		    (twittering-current-timeline-data
		     '(user "johnkitchin")))))
  (format  "%s - %s"
	   (format-time-string "%D %k:%M %p" (cdr (assoc 'created-at most-recent)))
	   (cdr (assoc 'text most-recent))))
#+END_SRC

#+RESULTS:
#+BEGIN_SRC emacs-lisp
"07/02/15  9:42 AM - nil"
#+END_SRC

#+BEGIN_SRC emacs-lisp
(get-most-recent-tweet "johnkitchin")
#+END_SRC

#+RESULTS:
: 07/02/15  9:26 AM - nil
...
#+BEGIN_SRC emacs-lisp
(twittering-current-timeline-data '(user "johnkitchin"))
#+END_SRC
#+RESULTS:

#+BEGIN_SRC emacs-lisp
(twittering-get-status-url "johnkitchin")
#+END_SRC
#+RESULTS:
: http://twitter.com/johnkitchin
