...
#+RESULTS:
#+begin_example
* 4cec2c7 Sun Oct 19 12:21:27 2014 | save (HEAD, source) [John Kitchin]
...
* ce91b4a Sun Oct 19 12:13:29 2014 | save [John Kitchin]
* f9ef1b4 Sun Oct 19 09:33:51 2014 | source-commit [John Kitchin]
#+end_example

It seems to be working. I should consider something other than save for the message, but this will allow me to run [[https://github.com/pidu/git-timemachine][git-timemachine]] on the file to see what changes were made. It does not
