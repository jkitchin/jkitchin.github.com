...
(defun pydoc-make-file-link ()
  ...
  (when (re-search-forward "^FILE
	...
	`(lambda ()
      ...
      ;(remove-text-properties start end '(mouse-face nil))
      (set-text-properties
       start end
       `(local-map, map
...
Mehak Chawla awarded a Prengle Fellowship ([[http://kitchingroup.cheme.cmu.edu/blog/2014/03/24/Mehak-Chawla-selected-as-the-H-William-and-Ruth-Hamilton-Prengle-Fellow-of-Chemical-Enginering-for-2013-2014/][link]]).
