...
#+BEGIN_SRC emacs-lisp
(defhydra goto (:color blue) "navigate"
  ...
  ("w" ace-window "window")
  ("h" helm-org-headlines "org headline in buffer")
  ("a" helm-org-agenda-files-headings "org headline in agenda")
  ("o" helm-occur "occur")
