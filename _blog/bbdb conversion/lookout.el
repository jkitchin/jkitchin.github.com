...
(defconst lookout-diary-mapping-table-outlook-german
  '(("all-day-event"      . "GanztÃ¤giges Ereignis")
...
(defconst lookout-bbdb-mapping-table-outlook-german
  '(("lastname" "Nachname" "Suffix")
    ...
    ("phones" "Telefon geschÃ¤ftlich" "Telefon geschÃ¤ftlich 2"
     "Telefon privat" "Telefon privat 2" "Mobiltelefon" "Weiteres Telefon"
     "Telefon Assistent" "Fax geschÃ¤ftlich" "Autotelefon" "Telefon Firma"
     "Fax privat" "Weiteres Fax" "Pager" "Haupttelefon" "Mobiltelefon 2"
     "Telefon fÃ¼r HÃ¶rbehinderte" "Telex")
    ("addr1" "StraÃŸe geschÃ¤ftlich" "StraÃŸe geschÃ¤ftlich 2"
     "StraÃŸe geschÃ¤ftlich 3" "Postleitzahl geschÃ¤ftlich" "Ort geschÃ¤ftlich"
     "Region geschÃ¤ftlich" "Land geschÃ¤ftlich")
    ("addr2" "StraÃŸe privat" "StraÃŸe privat 2" "StraÃŸe privat 3"
     "Postleitzahl privat" "Ort privat" "Region privat" "Land privat")
    ("addr3" "Weitere StraÃŸe" "Weitere StraÃŸe 2" "Weitere StraÃŸe 3"
     "Weitere Postleitzahl" "Weiterer Ort" "Weitere Region" "Weiteres Land")
    ("aka" "FIXME")
    ("notes" "Notizen")
    ("otherfields"
     "RÃ¼ckmeldung" "Abrechnungsinformation" "Benutzer 1"
     "Benutzer 2" "Benutzer 3" "Benutzer 4" "Beruf" "BÃ¼ro"
     ...
     "Organisations-Nr." "Ort" "Partner" "Postfach" "PrioritÃ¤t" "Privat"
     "Regierungs-Nr." "Reisekilometer" "Sprache" "StichwÃ¶rter"
