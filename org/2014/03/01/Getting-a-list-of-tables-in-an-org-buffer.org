...
[[list-of-tables:clickme][List of Figures]]
   ...
   (let* ((c-b (buffer-name))
	  ...
	  (list-of-tables 
	   (org-element-map (org-element-parse-buffer 'element) 'table
		 ...
		 (if caption (format "[[elisp:(progn (switch-to-buffer \"%s\")(goto-char %s))][table %s: %s]] %s\n" 
				     c-b start counter (or name "") caption)
		   (format "[[elisp:(progn (switch-to-buffer \"%s\")(goto-char %s))][table %s: %s]]\n" 
